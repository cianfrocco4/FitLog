//
//  GlanceLastSessionWorkingCopyTests.swift
//  FitLogTests
//
...
@Suite struct GlanceLastSessionWorkingCopyTests {
    ...
    @Test func latestCompletedSessionIsMostRecentEnd() {
        ...
        let latest = GlanceLastSessionWorkingCopy.latestCompletedSession(in: [older, newer])
    ...
    @Test func sourceWorkoutPrefersLibraryPlanOrigin() {
        ...
        let source = GlanceLastSessionWorkingCopy.sourceWorkout(session: session, library: [library])
    ...
    @Test func sourceWorkoutFallsBackToSessionSnapshotWhenLibraryMissing() {
        ...
        let source = GlanceLastSessionWorkingCopy.sourceWorkout(session: session, library: [])
        #expect(source?.name == "Ad hoc")
        #expect(source?.exercises.isEmpty == false)
    }

    @Test func a11yIdentifiersStayUniqueToGlanceSurfaces() {
        #expect(FitLogA11yID.homeWeekStripLastSession == "fitlog.homeWeekStrip.lastSession")
        #expect(FitLogA11yID.homeWeekStripStartThisWorkout == "fitlog.homeWeekStrip.startThisWorkout")
        #expect(FitLogA11yID.programGalleryLastSession == "fitlog.programGallery.lastSession")
        #expect(FitLogA11yID.programGalleryStartThisWorkout == "fitlog.programGallery.startThisWorkout")
        #expect(FitLogA11yID.subscriptionSettingsLastSession == "fitlog.subscriptionSettings.lastSession")
        #expect(FitLogA11yID.subscriptionSettingsStartThisWorkout == "fitlog.subscriptionSettings.startThisWorkout")
    }
