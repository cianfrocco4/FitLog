//
//  HubLastSessionWorkingCopyTests.swift
//  FitLogTests
//
...
@Suite struct HubLastSessionWorkingCopyTests {
    ...
    @Test func latestCompletedSessionIsMostRecentEnd() {
        ...
        let latest = HubLastSessionWorkingCopy.latestCompletedSession(in: [older, newer])
    ...
    @Test func sourceWorkoutPrefersLibraryPlanOrigin() {
        ...
        let source = HubLastSessionWorkingCopy.sourceWorkout(session: session, library: [library])
    ...
    @Test func sourceWorkoutFallsBackToSessionSnapshotWhenLibraryMissing() {
        ...
        let source = HubLastSessionWorkingCopy.sourceWorkout(session: session, library: [])
        #expect(source?.name == "Ad hoc")
        #expect(source?.exercises.isEmpty == false)
    }

    @Test func a11yIdentifiersStayUniqueToHubSurfaces() {
        #expect(FitLogA11yID.moreTabLastSession == "fitlog.moreTab.lastSession")
        #expect(FitLogA11yID.moreTabStartThisWorkout == "fitlog.moreTab.startThisWorkout")
        #expect(FitLogA11yID.programDetailLastSession == "fitlog.programDetail.lastSession")
        #expect(FitLogA11yID.programDetailStartThisWorkout == "fitlog.programDetail.startThisWorkout")
        #expect(FitLogA11yID.cardioBuilderLastSession == "fitlog.cardioBuilder.lastSession")
        #expect(FitLogA11yID.cardioBuilderStartWorkout == "fitlog.cardioBuilder.startWorkout")
    }
