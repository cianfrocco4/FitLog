//
//  EntryLastSessionRecapBlock.swift
//  FitLog
//
//  Compact last-session recap + Start this workout for Coach, program-builder
//  entry, and the empty Plan hero — not More, History, Home rows, Plan day,
//  or week-in-review (other nightlies).
//

import SwiftUI

struct EntryLastSessionRecapBlock: View {
...
#Preview("Light") {
    EntryLastSessionRecapBlock(
        recap: EntryLastSessionWorkingCopy.Recap(
            workoutName: "Push A",
