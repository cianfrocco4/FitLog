//
//  EntryLastSessionWorkingCopy.swift
//  FitLog
//
//  Last-session working load (warm-ups skipped) and a fresh Start from Coach,
//  program-builder entry, and the empty Plan hero. Unique vs other nightly
//  helpers: HubLastSessionWorkingCopy (b8e1), LastCompletedSessionWorkingCopy
//  (3f91), LastSessionWorkingRecap (e2c4), LibraryWorkoutLastSessionCopy
//  (a209), HistoryStartFreshWorkout (9816/a831).
//

import Foundation

enum EntryLastSessionWorkingCopy {
