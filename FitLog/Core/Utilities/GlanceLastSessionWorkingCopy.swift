//
//  GlanceLastSessionWorkingCopy.swift
//  FitLog
//
//  Last-session working load (warm-ups skipped) and a fresh Start from the
//  Home week strip, program template gallery, and Subscription settings.
//  Unique vs other nightly helpers: EntryLastSessionWorkingCopy (c7a2),
//  HubLastSessionWorkingCopy (b8e1), LastCompletedSessionWorkingCopy (3f91),
...
enum GlanceLastSessionWorkingCopy {
