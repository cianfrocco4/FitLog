...
| `fitlog.history.startThisWorkout` | History **Start this workout** (muscle / workout detail) |
| `fitlog.readiness.startThisWorkout` | Readiness details **Start this workout** |
