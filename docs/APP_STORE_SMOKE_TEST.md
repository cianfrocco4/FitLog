...
| UI journeys | `FitLogUITests` plus **daily living** (`scripts/run-daily-living-users.sh`) to grow History. Snapshot UI tests stay on a Mac / `fitlog-mac` (not GitHub iOS CI). See [AUTOMATED_USER_TESTING.md](AUTOMATED_USER_TESTING.md). |
